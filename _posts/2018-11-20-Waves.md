...
projects: true
category: project
summary: "An investment research analysis of the Waves blockchain for Messari — custom token creation, fiat gateways, and decentralized trading."
permalink: projects/Waves
---
# Waves - Analysis for Investment Platform Messari

Another teardown from my volunteer stint as a Messari research analyst. Waves makes a seductively simple promise: let anyone create and trade their own token without writing a line of smart-contract code — crowdfunding, loyalty points, or an in-app currency, a few clicks away. Here's how the platform actually held up.
