...
blog: true
category: project
summary: "A sales analysis for a small NYC beach cafe — revenue, retention, customer lifetime value, and RFM segmentation from three summers of Square data."
permalink: projects/fruity
---
## Sales analysis for a small beach cafe in New York
![png](/assets/images/posts/fruit/fruit-main.jpg)

Fruteria is a seasonal beach café in New York — breakfast, smoothies, and healthy fare, with three summers of sales run through Square. I wanted to understand the business the way an owner wishes they could: how it's really growing, who its best customers are, and what would help it grow further. There was also a natural experiment baked in — in the summer of 2018, half a mile of the beach out front was closed for sand erosion, so I could measure almost exactly what that cost them. 

### 1. How does the company make money?

The revenue is realized from daily sales, for about 4 months a year, with **July** the best performing month every year. The **total sales**, as well as total transactions, have indeed suffered in 2018, by 5.8% and 7%, respectively. In terms of **average daily sales**, this year has already beaten 2017 and 2018 by  12% and 28%. Top 5 **biggest sale days** in 2019 have been bigger than top 5 biggest sale days in 2018. 
