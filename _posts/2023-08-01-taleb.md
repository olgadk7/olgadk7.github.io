...
projects: true
category: project
summary: "Key lessons from Nassim Taleb's Real World Risk Institute — fat tails, redundancy, convexity, skin in the game, and surviving uncertainty."
...
Nassim Taleb has a reputation — pugnacious online, allergic to fools, happy to tell a Nobel laureate he's wrong. So the most surprising thing about a week inside his Real World Risk Institute (RWRI) was how *fair* he is in person: deliberate, patient, obsessed with clarity, and far more interested in whether an idea survives contact with reality than in winning the argument.

RWRI is a crash course in thinking about risk, uncertainty, and fragility the way the world actually behaves — fat tails, not tidy bell curves. Having finished it, here are the principles that stuck, and how I'd actually put them to use.
