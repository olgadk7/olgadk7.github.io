...
author: Olga Kahn
category: project
summary: "Lessons on generative and probabilistic thinking — the Bayesian workflow, choosing distributions, and prediction versus inference."
permalink: projects/probabilistic-thinking
redirect_from:
  - /projects/recap
  - /projects/recap/
comments: true
...
The past year taught me some lessons the hard way — statistical, programmatic, managerial, psychological. The statistical ones changed how I see almost everything: instead of asking a model to *predict* the future, I learned to ask how the data could have been *generated* in the first place. This is a recap of that shift — generative thinking, probabilistic thinking, and the Bayesian workflow that ties them together.
